                    ...
                    for CVh_mult in CVh_mult_vec:
                        for L_mult in L_mult_vec:
                            for CVL_mult in CVL_mult_vec:
                                ...
                                #--------------------------------------------------------------------------
                                # Make SBTACH
                                inpath = currwd + "/dmft_opto_normalization.py"
                                ...
                                if np.isclose(SoriE_mult,1.0) and np.isclose(SoriI_mult,1.0) and\
                                    ...
                                    jobname="dmft_opto_normalization"+"-c-{:d}".format(c)
                                else:
                                    jobname="dmft_opto_normalization"+"-SoriEx{:.2f}-SoriIx{:.2f}-SoriFx{:.2f}-CVhx{:.2f}-Jx{:.2f}-betax{:.2f}-gEx{:.2f}-gIx{:.2f}-hEx{:.2f}-hIx{:.2f}-Lx{:.2f}-CVLx{:.2f}-c-{:d}".format(
