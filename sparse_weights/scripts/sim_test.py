...
def simulate_networks(prms,rX,cA,CVh):
    ...
    for seed_idx,seed in enumerate(seeds):
        ...
        net,this_M,this_H,this_B,this_LAS,this_EPS = su.gen_ring_disorder_tensor(seed,prms,CVh,diff_base=True)
        M = this_M.cpu().numpy()
...
res_file = './../results/sim_test_id_{:s}'.format(str(id))
