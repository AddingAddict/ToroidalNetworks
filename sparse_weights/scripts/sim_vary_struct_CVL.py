...
parser.add_argument('--CVL_idx', '-c',  help='which CVL', type=int, default=0)
args = vars(parser.parse_args())
print(parser.parse_args())
struct_idx= args['struct_idx']
CVL_idx= args['CVL_idx']
...
print('simulating CVL # '+str(CVL_idx+1))
print('')
newCVL = CVLs[CVL_idx]
...
with open('./../results/vary_struct_{:d}_CVL_{:d}'.format(struct_idx,CVL_idx)+'.pkl', 'wb') as handle:
