...
class network(object):
    ...
    def generate_full_kernel(self,Srf,Sori,kernel="gaussian"):
        ori_diff = self.get_ori_diff(byloc=True)
        rf_xdiff,rf_ydiff = self.get_rf_diff(byloc=True,return_mag=False)
