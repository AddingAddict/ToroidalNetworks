...
parser.add_argument('--disord_idx', '-d',  help='which disordered', type=int, default=0)
args = vars(parser.parse_args())
print(parser.parse_args())
struct_idx= args['struct_idx']
disord_idx= args['disord_idx']
...
print('simulating disord # '+str(disord_idx+1))
print('')
disord = disords[disord_idx]
...
this_prms['K'] = int(K/disord)
this_prms['J'] = J*(K/this_prms['K'])
...
with open('./../results/vary_struct_{:d}_disord_{:d}'.format(struct_idx,disord_idx)+'.pkl', 'wb') as handle:
