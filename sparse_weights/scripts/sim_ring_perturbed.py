...
def gen_prms(seed):
    ...
    prm_dict['K'] = 500
    prm_dict['SoriE'] = rng.uniform(0.9,1.1)*fit_prms['SoriE']
    prm_dict['SoriI'] = rng.uniform(0.9,1.1)*fit_prms['SoriE']
    prm_dict['SoriF'] = fit_prms['SoriF']
    prm_dict['J'] = rng.uniform(0.9,1.1)*fit_prms['J']
    prm_dict['beta'] = rng.uniform(0.9,1.1)*fit_prms['beta']
    prm_dict['gE'] = rng.uniform(0.9,1.1)*fit_prms['gE']
    prm_dict['gI'] = rng.uniform(0.9,1.1)*fit_prms['gI']
    prm_dict['hE'] = rng.uniform(0.9,1.1)*fit_prms['hE']
    prm_dict['hI'] = rng.uniform(0.9,1.1)*fit_prms['hI']
    prm_dict['L'] = rng.uniform(0.9,1.1)*fit_prms['L']
    prm_dict['CVL'] = rng.uniform(0.9,1.1)*fit_prms['CVL']
